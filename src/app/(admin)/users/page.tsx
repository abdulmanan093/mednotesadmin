...
// Helper to map DB row to frontend User type
...
export default function UsersPage() {
  ...
  useEffect(() => {
    Promise.all([getUsers(), getBlocks()]).then(([users, blocks]) => {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      setUserList(users.map((u: any) => mapDbUser(u)));
      setBlockList(
  ...
  if (view === "edit") return renderForm("edit");
